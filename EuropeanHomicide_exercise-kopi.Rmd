...
date: " created 29/11/2022, updated date: `r format(Sys.time(), '%d %B, %Y')`" 
output:
  html_document:
    toc: true
    toc_float: true
...
Western_Europe %>% 
  ...
  labs(title = "homecide trend", x = "Time", y = "Homicide rate pr. 100K", color = "Country")
...
kings %>% 
  ...
  geom_smooth() +
  labs(title = "Danish regenst reign midyear")
```
...
the genneral fall in homicide rates and the rising lifespan of monarchs could very well be tied to the development of a more civil society. Falling homecide rates could however allso be an indication of a more estaplished justice system making it more risky to commit homecide and the increasing lifespan og monarcs could be conected to the development in the sceince around health care